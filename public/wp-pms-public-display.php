    ...
    <body onload="table_elements(1)">
        <div class="container-fluid">
            <div class="card-header border-0">
                <h3 class="mb-0">Printing Management System</h3>
            </div>
        </div>
        <div class="container-fluid">
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="A value of the table" aria-label="value of tabel" aria-describedby="basic-addon2">
        ...
        <div class="container-fluid">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" name="inlineRadioOptions" id="inlineCheckbox1" value="all">
                <label class="form-check-label" for="inlineCheckbox1">All</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" name="inlineCheckboxOption" id="inlineCheckbox2" value="complete">
                <label class="form-check-label" for="inlineCheckbox2">Completed</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" name="inlineCheckboxOption" id="inlineCheckbox3" value="package">
                <label class="form-check-label" for="inlineCheckbox3">Packaging</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" name="inlineRadioOptions" id="inlineCheckbox4" value="ship">
                <label class="form-check-label" for="inlineCheckbox4">Shipping</label>
            </div>
        </div>
        <div class="col">
            <div>
